...
Aprovechando la heurística de Fiat-Shamir, podemos convertir el protocolo en un esquema de firma digital de un mensaje $m$, aplicando el \textit{hash} sobre el testigo y el mensaje a la vez:
...
\section{TODO Conclusiones}

BORRADOR

Antes de introducir las aplicaciones prácticas de las pruebas de conocimiento cero, es importante repasar lo que hemos conseguido hasta ahora.

Comenzamos con una pequeña base de teoría de la computación, que en el Grado de Matemáticas apenas se llega a mencionar para comprender la eficiencia de los algoritmos en asignaturas como 	Cálculo Numérico en Una Variable o Métodos Numéricos de Ecuaciones Diferenciales. Sin embargo, esta teoría es vital para comprender qué problemas se utilizan en la seguridad informática actual.

Que un problema sea difícil de resolver, no implica que sea difícil de entender, como se comentó durante el seminario \textit{Grupos y criptograf\'ia: de Julio Cesar a las curvas el\'ipticas} de Adolfo Quirós, el pasado abril. Esto lo comprobamos al estudiar los preliminares del trabajo, donde la teoría de grafos y álgebra extienden su desarrollo durante el Grado, excepto quizás, los residuos cuadráticos, cuya teoría, por desgracia, ya no se incluye en el plan de estudios del Grado. De esta teoría, enunciamos y realizamos un análisis de los problemas de isomorfismo de grafos, 3-coloración de grafos, factorización, residuos cuadráticos y logaritmo discreto.

En este mismo capítulo realizamos el estudio formal de la teoría que da nombre al trabajo, y mostramos las pruebas de conocimiento cero más características y utilizadas en la práctica. De estudiar las pruebas de conocimiento cero perfectas comprendemos el acertado nombre de \textit{conocimiento cero}, pues ninguna máquina podría obtener de ellas más información que la que quieren demostrar. Debido a las fuertes restricciones que la definición original imponía, estudiamos otros tipos de pruebas que en la práctica, con los computadores actuales, consiguen la misma propiedad de no revelar más información. De las pruebas con Verificador Honesto la confianza proviene de no conocer ataques viables al actuar como un Verificador tramposo. Sin embargo, en las pruebas computacionales, utilizamos los esquemas de compromiso con secreto computacional, que nos permite demostrar que cualquier Verificador, incluso uno malicioso, con restricción computacional, será incapaz de obtener más información de la prueba.
