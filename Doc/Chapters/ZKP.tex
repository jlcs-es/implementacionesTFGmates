...
\subsection{Esquemas de compromiso}
...
Nos interesan en particular sistemas como el del problema de la 3-coloración, donde la solución se escondía tras $n$ criptogramas, que podemos ver como cajas negras, que sólo se pueden abrir si se tiene la llave. El Probador, al enviar todas las cajas negras, se compromete con la permutación, no puede cambiar los valores escondidos, y el Verificador en su reto pide a P que abra cajas al azar para revelar el color, peor no la 3-coloración completa.

Los \textit{esquemas de compromiso} son una herramienta necesaria en las pruebas de conocimiento cero computacionales de todos los problemas \textbf{NPC}. Esconde la estructura de una instancia $Verdadera$ y P se compromete con su \textit{testigo} antes de conocer el \textit{reto} de V. En la última \textit{respuesta} de P, se revelará una pequeña parte de la estructura de la instancia $Verdadera$, de la cual V no puede aprender nada.
