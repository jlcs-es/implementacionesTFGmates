...
\begin{definition}\index{Grupo}\index{Abeliano}
...
\begin{definition}\index{Generador}\index{Grupo cíclico}
...
\begin{definition}\index{Unidad}\index{Grupo de las unidades}
...
\begin{definition}\index{Homomorfismo}\index{Isomorfismo}
...
\begin{definition}\index{Congruencia}\index{Módulo}
...
\begin{algorithm}[Algoritmo de Euclides]\index{Algoritmo de Euclides}
...
\begin{algorithm}[Algoritmo de Euclides Extendido]\index{Euclides Extendido}
Dados dos enteros $a$ y $b$ entonces podemos encontrar el m\'aximo com\'un divisor
...
\begin{definition}\index{Función de Euler}
...
\begin{theorem}[de Euler]\index{Teorema de Euler}
...
\begin{theorem}[Teorema Chino de los Restos]\index{Teorema Chino de los Restos} Sean $m$ y $n$ dos n\'umeros enteros
...
\begin{definition}\index{Residuo Cuadrático}\index{Raíz modular}\index{No-Residuo Cuadrático}
...
\begin{definition}\index{Símbolo de Legendre}
...
\begin{definition}\index{Símbolo de Jacobi}
...
\begin{definition}\index{B-smooth}\index{Base de factores}
...
Utilizando el Algoritmo de Tonelli\index{Algoritmo de Tonelli} podemos resolver el problema de calcular
